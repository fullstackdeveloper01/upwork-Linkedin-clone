<template>
  <b-container>
    <b-row class="mt-100 freelancer-wrap my-proposals">
      <b-col>
        <h4 class="mb-3 fz-30 fw-500 text-black"><b>All Invitations</b></h4>
        <div>
...
export default {
  ...
  methods:{
    ...
    ...mapActions("settings",["enCodeId"]),
    // this fun is for to job invitation list
    async getInvitationList(){
      var ALI = this.enCodeId(10);
