  ...
  <div class="search-filter-wrapper border-bottom pb-0 br-20 bg-white freelancer-wrap mt-12">
    <b-row>
      <b-col xl="12" lg="12" md="12" class="pb-0">
        <template v-if="offerData.length > 0">
          <div class="profile-wrap mb-0 px-4 pt-0 py-4 pos-rel job-card" v-for="(proposal, id) in offerData" :key="id">
            <b-row>
              ...
              <b-col cols="4" class="text-right d-flex align-items-center justify-content-end pb-0">
                <div class="action-btn d-flex align-items-center top-13">
                  ...
                  <a class="btn btn-theme" href="javascript:void(0);" @click="$router.push({name:'offerdeatils',path:'/client/offer-details',params:{ pid:proposal.uniq_id,uid:encodedid(proposal.user_id)}}).href">View Offer</a>
                </div>
              </b-col>
