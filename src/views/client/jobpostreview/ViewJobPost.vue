            ...
            <b-col xl="9" lg="9" sm="12" class="left">
              ...
              <div class="content px-4 py-4" v-if="jobDetails!=''">
                <p class="fw-400 fz-16 mb-0 text-muted">
                  <read-more more-str="Read more" :text="jobDetails.scope_of_work" link="#" less-str="Read less" :max-chars="500"></read-more>
                </p>
              </div>
              <div class="content px-4 py-4" v-if="jobDetails!=''">
                <!-- <div class="d-flex align-items-center">
                    <ul  class="ml-2 mt-4 attachment "  v-if="jobDetails.attachment.length > 0" style="border: 1px dashed #6666664d;padding: 6px 0px;">
                      ...
                      <li class="attatchment-wrap mr-5 mb-2" v-for="(attc, index) in jobDetails.attachment" :key="index" style="border: 1px dashed #c1000057;border-radius: 20px;background-color: #c100000d;padding: 2px 10px;margin-right: 5px;display:inline-block;">
              ...
              <div class="row px-4 py-4 activity">
                ...
                <div class="col-lg-4 col-md-12">
                  ...
                  <ul class="custom-margin">
                    <li class="text-muted fz-16 mb-1 fw-600"><span>Proposals:</span>  {{jobApplicationStatus.jobApplicantCount}}</li>
                    <!-- <li class="text-muted fz-16 mb-1 fw-600"><span>Interviewing:</span>  {{jobApplicationStatus.jobHireApplicantCount}}</li>
                    <li class="text-muted fz-16 mb-1 fw-600"><span>Invites sent:</span>  {{jobApplicationStatus.jobShortlistedApplicantCount}}</li>
                    <li class="text-muted fz-16 mb-1 fw-600"><span>Unanswered invites:</span>  {{jobApplicationStatus.jobRejectedApplicantCount}}</li> -->
              ...
              <div class="options px-4 py-4">
                <ul class="custom-margin">
                  <li class="mb-3"  v-if="jobDetails.is_delete == 0">
                    <a href="javascript:void(0);" class="text-theme d-flex align-items-center" @click="$router.push({ name: 'postReview', path:'/client/post-review', params: {pid: jobDetails.uniq_id} });">
                  ...
                  <li class="mb-3">
                    <a href="javascript:void(0);" class="text-theme d-flex align-items-center" @click="$router.push({ name: 'clientDashboard', path:'/client/dashboard', })">
...
<script>
  ...
  export default {
    props:['jobDetails','ratingsData','userDetails','jobApplicationStatus'],
    data() {
      return {
        jobLink:'',
        selected: null,
    ...
    mounted() {
      if(this.$route.params.pid != undefined){
        ...
        this.jobLink = window.location.origin+'/client/jobpostreview/'+this.uniqe_id;
      }else{
