<template>
    <b-sidebar id="sidebar-message" ref="mySidebar" title="" shadow right backdrop class="sidebar-message"
        ...
        <div class="px-3 py-2 br-20">
            <b-card-group deck>
                <b-card title-class="text-theme font-14" header-tag="header" footer-tag="footer" class="br-20"
                    ...
                    <template #header>
                        <div class="d-md-flex align-items-center">
                            ...
                            <div class="ml-auto text-theme d-flex align-items-center">
                                <a class="d-flex align-items-center" :href="$router.resolve({name: 'messageDetails',path:'/client/jobpostreview/message-details/',params: {pid:job_id,uid:messageData.userDetails.user_id}}).href"
                                    target="_blank">
                    ...
                    <b-row>
                                    ...
                                    <div class="d-md-flex align-items-start text-left">
                                        ...
                                        <div class="content ml-2">
                                            <h4 class="fz-20 fw-600 text-black mr-2 mb-0">
                                                {{messageData.userDetails.first_name+' '+messageData.userDetails.last_name}}</h4>
                                            ...
                                            <h6 class="mb-0"><a class="text-theme" href="javascript:void(0);"
                                                    @click="$router.push({name:'ViewProfile',path:'/client/jobpostreview/ViewProfile',params:{pid:job_id,uid:messageData.userDetails.user_id}})">View
                                                    Profile</a></h6>
                                        ...
                                        <div class="ml-auto d-flex align-items-center">
                                            ...
                                            <span
                                                v-if="messageData.proposalDetails.application_status !=2 && messageData.proposalDetails.application_status > 4">
                                                <b-button class="mr-2 btn-outline-theme"
                                                    v-if="messageData.proposalDetails.application_status != 3"
                                                    @click="proposalLike(3)">Shortlist</b-button>
                                                <b-button class="mr-2 btn-outline-theme" v-else>Shortlisted</b-button>
                                            </span>
                                            <a class="mr-2 btn-theme" v-if="messageData.proposalDetails.application_status != 7 && messageData.proposalDetails.application_status !=2" target="_blank" :href="$router.resolve({name:'hiredetails',path:'/client/hire-details/',params:{ 'pid':job_id,'uid':encodedid(messageData.userDetails.user_id)}}).href">Hire
                                                Freelancer</a>
                                            ...
                                            <b-button variant="outline-secondary"
                                                ...
                                                @click="addFavorite(messageData.userDetails.user_id)"><i
                                                    class="fa fa-heart-o" aria-hidden="true"></i></b-button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <b-col lg="4" xl="4" sm="12" class="p-0">
                            ...
                            <!-- <div class="border-right text-left py-4 px-4">
                                <h6 class="fw-500">Get a second opinion</h6>
                                <p>Invite coworkers to help you review freelancers</p>
                                <b-button class="btn-outline-theme">Invite</b-button>
                            </div>   -->
                        </b-col>
                        <b-col lg="8" xl="8" sm="12" class="p-0">
                            <div class="border-left text-left py-4 px-4" v-if="messageData.proposalDetails!=''">
                                <div class="d-md-flex align-items-center">
                                    <h4 class="mb-4 fz-24 fw-500 text-black"><b>Proposal Details</b></h4>
                                    <div class="ml-auto">
                                        <h5 class="mb-0">${{messageData.proposalDetails.cost}}</h5>
                                        <p class="mb-0 fz-14">Proposed Bid</p>
                                    </div>
                                </div>
                                <h5 class="mb-4 fw-600">Cover letter</h5>
                                <!-- <vue-read-more-smooth :lines="2" class="mt-2"  v-if="messageData.proposalDetails.cover_letter!=''">
                                    <p class="mb-2"> {{messageData.proposalDetails.cover_letter}}
                                    </p>
                                </vue-read-more-smooth> -->
                                <!-- <p>{{messageData.proposalDetails.cover_letter}}</p> -->
                                <p v-if="messageData.proposalDetails.cover_letter!=''">
                                    <read-more more-str="Read more" :text="messageData.proposalDetails.cover_letter" link="#" less-str="Read less" :max-chars="250"></read-more>
                                </p>
                                <br>
                                <div class="thanks-wrap mb-4">
                                    <div>
                                        <ul  class="ml-2 pl-0 mt-4 attachment "  v-if="messageData.proposalDetails.attachment" style="padding: 6px 0px;">
                                            <template v-for="(attc, index) in messageData.proposalDetails.attachment">
                                            <li class="attatchment-wrap mr-5 mb-2"  :key="index" v-if="index >= 0" style="border-radius: 20px;padding: 2px 10px;margin-right: 5px;">
                                                ...
                                                <a :href="messageData.proposalDetails.attachmentwithUrl+'/'+attc" target="_blank"><span class="ml-2 text-theme">{{attc}}</span></a>
                                            </li>
                                            </template>
                                        </ul>
                                    </div>
                                ...
                                <hr>
                                <span v-if="messageData.proposalDetails.question">
                                    <span v-for="(ques,index) in messageData.proposalDetails.question" :key="index">
                                ...
                                <div class="chat-wrap" style="height:500px;">
                                    <h5 class="fw-600">Chat with {{messageData.userDetails.first_name+' '+messageData.userDetails.last_name}}.</h5>
                                    <b-col xl="12" lg="12" sm="12" class="conversation">
                                                ...
                                                <div class="heading-avatar d-flex align-items-center">
                                                    <div class="width-98 d-flex align-items-center">
                                                        <div class="heading-name">
                                                            <a class="heading-name-meta mb-0 pt-0 fz-18 fw-600">{{ chatroomdata.user_first_name }} {{ chatroomdata.user_last_name }}</a>
                                        ...
                                        <chatBoxData ref="oprateChatbox" :chatroomdata="chatroomdata" :pageType="'sidebar'" />
                    ...
                    <b-row>
                        <b-col lg="4" xl="4" sm="12" class="p-0">
                            ...
                            <div class="border-bottom text-left py-4 px-4">
                                ...
                                <h5><b>Languages</b></h5>
                                <p class="mb-4" v-if="messageData.userDetails.language!=''"><span>{{messageData.userDetails.language}}:</span>
                                    <span v-if="messageData.userDetails.proficiency_id == 1">Basic</span>
                                    <span v-if="messageData.userDetails.proficiency_id == 2">Conversational</span>
                                    <span v-if="messageData.userDetails.proficiency_id == 3">Fluent</span>
                                    <span v-if="messageData.userDetails.proficiency_id == 4">Native or Bilingual</span>
                                    <span v-if="messageData.userDetails.proficiency_id == '' && messageData.userDetails.proficiency_id == null">Not Found</span>
                                </p>
                        ...
                        <b-col lg="8" xl="8" sm="12" class="p-0">
                            <div class="border-left border-bottom text-left py-4 px-4" v-if="messageData.userDetails!=''">
                                ...
                                <!-- <vue-read-more-smooth :lines="2" class="mt-2"  v-if="messageData.userDetails.about_self_desc!=''"> -->
                                    <p class="mb-2"> 
                                        <read-more more-str="Read more" :text="messageData.userDetails.about_self_desc" link="#" less-str="Read less" :max-chars="250"></read-more>
                                    </p>
                                <!-- </vue-read-more-smooth> -->
                            ...
                            <div class="border-left border-bottom text-left py-4 px-4" v-if="messageData.jobHistory.length>0">
                                ...
                                <div class="tabs-wrapper work-history-wrapper">
                                    <b-tabs>
                                        <b-tab :title="'Completed jobs ('+messageData.jobHistory.length+')' "
                                            active>
                                            <span v-if="messageData.jobHistory.length > 0">
                                                <b-card-text class="border-bottom"
                                                    v-for="(history,index) in messageData.jobHistory" :key="index">
                                        ...
                                        <b-tab :title="'In progress ('+messageData.jobUnderprocess.length+')'" v-if="messageData.jobUnderprocess.length > 0">
                                            <span v-if="messageData.jobUnderprocess.length > 0">
                                                <b-card-text class="border-bottom"
                                                    v-for="(jobUnderprocess,index) in messageData.jobUnderprocess"
                                                    :key="index">
                            ...
                            <div class="border-left border-bottom text-left py-4 px-4" v-if="messageData.userDetails.allSkill_name!=''">
                                ...
                                <div class="tags-wrap">
                                    <ul v-if="messageData.userDetails.allSkill_name">
                                        <li v-for="(catname,index) in messageData.userDetails.allSkill_name"
                                            :key="index">
        ...
        <b-modal id="notemodal" class="notemodal" size="lg" :title="'Note about '+messageData.userDetails.first_name+' '+messageData.userDetails.last_name+'.'" hide-footer no-close-on-backdrop>
            <form @submit.prevent="submitNoteData">
                ...
                <b-form-tags v-model="messageData.noteData.tags" input-id="tags-pills" tag-variant="primary" tag-pills
...
export default {
    ...
    props: ['messageData', 'proposal', 'jobId','jobDetails'],
    data() {
        return {
    ...
    mounted() {
        ...
        // this fun is for to get chatroomdata
        this.getChatlist();
        //this fun is for to get flagging reason
        this.getflagging();
...
.work-history-wrapper .nav-tabs .nav-link{color:#666666;border: 0;}
