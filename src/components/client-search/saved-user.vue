    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        >
                ...
                <b-col xl="12" lg="12" md="12">
                  <div class="d-flex align-items-center justify-content-space-between search-input">
                    <b-input-group class="mt-0">
                      ...
                      <b-form-input v-model="titleSearch" @keyup="filterByData()" placeholder="Search Saved User"></b-form-input>
                    </b-input-group>
                  </div>
                </b-col>
              </b-row>
            ...
            <div class="job-card py-2 px-4 pb-4 mb-0 text-theme-hover"  v-for="(data,index) in userData" :key="index" :id="data.jobs_id">
                ...
                <a target="_blank" :href="$router.resolve({name: 'hireFreelancer',  path:'/client/hire-freelancer/', params: {uid: 'A'+encodedid(data.login_master_id)}}).href"  class="btn btn-theme btn-block mb-2 mr-2 btn-secondary"> Hire </a>
                <button type="button" v-if="jobDetails.is_delete == 0"  class="btn btn-theme btn-block mb-2 mr-2 btn-secondary" :disabled="(data.invited_job > 0 ) ? true : false" v-b-modal.invite-job-modal-4 @click="inviteModelData(data)"> Invite to Job </button>
                </div>
                <div class="d-flex align-items-center profile-wrap">
                <div class="img-wrapper pos-relk">
                    <div class="shadow-lg">
                ...
                <div class="ml-3">
                    ...
                    <!---<ul class=" align-items-center fz-14 post text-muted mb-2" >
                    <li>{{data.tagline}}</li> 
                    <li>
                    ...
                    <ul class=" align-items-center fz-14 post text-muted mb-0"   v-b-toggle.sidebar-right @click="sideBarData.jobDetails = jobDetails; sideBarData.userDetails = data; $refs.getUserDetailsData.getSidebarDatas()">
                      <li class="fz-16 text-black">{{data.tagline}}</li>
                    </ul>
                    <ul class="d-flex align-items-center fz-14 post text-muted mb-0"  v-b-toggle.sidebar-right @click="sideBarData.jobDetails = jobDetails; sideBarData.userDetails = data; $refs.getUserDetailsData.getSidebarDatas()">
                ...
                <div class="pl-30">
                  <b-row>
                    ...
                    <b-col xl="3" lg="3" md="3" sm="12" v-if="data.talent_id > 0">
                        <TalentBage :talentQualilty="talentQualilty" :talent_id="data.talent_id" v-if="data.talent_id !=''"/>
                    </b-col>
                  </b-row>
                </div>

                <span v-if="data.about_self_desc!=''">
                <!-- <vue-read-more-smooth :lines="3" class="mt-2"> -->
                    <p class="fz-16 text-muted mb-3 search-description pl-30 mt-3" v-html="data.about_self_desc"  v-b-toggle.sidebar-right  @click=" sideBarData.jobDetails = jobDetails ;sideBarData.userDetails = data; $refs.getUserDetailsData.getSidebarDatas()"> </p>
                <!-- </vue-read-more-smooth> -->
                </span>
                
                <div class="skill-slider-wrapper mt-3 pl-30">
                  <ul class="inline-block align-items-center fz-14 post tags mb-0 w-100 ml-0 ml--35" style="margin-left:-32px!important;" v-if="data.skillNameCertificate.length > 0">
            ...
            <div class="job-card py-8 px-4 pb-4 mb-2 text-center dashboard-empty">
                ...
                <p class="fz-20 fw-600 text-black mb-0">You haven’t saved anyone yet</p>
            </div>
            </div>
            <!-- right side bar  -->
            ...
            <b-modal centered no-close-on-backdrop id="invite-job-modal-4" size="lg" title="Invite to job" >
  ...
  export default {
    ...
    methods: {
      ...
      resetInvitationModel(){
        this.$bvModal.hide('invite-job-modal-4');
        this.$v.$reset();
