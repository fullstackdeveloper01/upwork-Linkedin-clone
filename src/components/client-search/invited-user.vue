    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        >
                ...
                <b-col xl="12" lg="12" md="12">
                  <div class="d-flex align-items-center justify-content-space-between search-input">
                    <b-input-group class="mt-0">
                      ...
                      <b-form-input v-model="titleSearch" @keyup="filterByData()" placeholder="Search Invited User"></b-form-input>
                    </b-input-group>
                  </div>
                </b-col>
              </b-row>
            ...
            <div class="job-card py-2 px-4 pb-4 mb-2 text-theme-hover"  v-for="(data,index) in userData" :key="index" :id="data.jobs_id">
                ...
                <button type="button"  class="btn btn-theme btn-block mb-2 mr-2 btn-secondary" v-b-modal.decline-modal @click="addDecline.invited_job = data.invited_job" > Decline </button>
                <!-- <button type="button"  class="btn btn-theme btn-block mb-2 mr-2 btn-secondary"> Hire </button> -->
                ...
                <div class="ml-2">
                    ...
                    <ul class=" align-items-center fz-14 post text-muted mb-0"  v-b-toggle.sidebar-right @click="sideBarData.userDetails = data; $refs.getUserDetailsData.getSidebarDatas()">
                      <li>{{data.tagline}}</li> 
                    </ul>
                    <ul class="d-flex align-items-center fz-14 post text-muted mb-0"  v-b-toggle.sidebar-right @click="sideBarData.userDetails = data; $refs.getUserDetailsData.getSidebarDatas()">
                ...
                <div class="pl-30 mb-3">
                  <b-row>
                      ...
                      <h5 class="text-black mb-0" ><b>{{data.jobSuccessRate}}%</b> Job Success</h5>
                      </b-col>
                ...
                <!-- <vue-read-more-smooth :lines="3" class="mt-2"> -->
                    <p class="fz-14 text-muted mb-2 pl-30 search-description" v-html="data.about_self_desc"  v-b-toggle.sidebar-right @click="sideBarData.userDetails = data; $refs.getUserDetailsData.getSidebarDatas()"> </p>
            ...
            <div class="job-card py-8 px-4 pb-4 mb-2 text-center dashboard-empty">
                ...
                <p class="fz-20 fw-600 text-black mb-0">You haven’t invited anyone yet</p>
            </div>
            </div>
            <!-- right side bar  -->
            ...
            <b-modal id="confirm-modal" title="Decline Invitation" centered hide-footer size="md" no-close-on-backdrop> 
                <template>
    ...
    methods: {
      ...
      async submitDeclineData(){
        ...
        if (!this.$v.addDecline.$invalid) {
            ...
            if (decline) {
              var that =this;
                this.userData.filter(function(data, index){
                  if(data.invited_job == that.addDecline.invited_job){
