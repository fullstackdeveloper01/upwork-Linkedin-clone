<template>
    <div>
        <b-row>
            <b-col xl="8" lg="8" sm="12" id="listDiv" style="display:none;">
            ...
            <b-col xl="4" lg="4" sm="12">
                ...
                <div class="d-flex align-items-start border-bottom px-4 py-1">
    ...
    export default {
        ...
        computed:{
            estimatedTax(){
                if(this.currentpayment_arr.amount > 0){
                    return (this.currentpayment_arr.amount/100)*4.5;
                    // return numeral(vale).format('0.000');
                }
            },
            estimatedTotal(){
                if(this.currentpayment_arr.amount > 0){
                    return parseInt(parseInt(this.currentpayment_arr.amount)+parseInt(this.estimatedTax));
                    // return numeral(vale).format('0.000');
                }
            },
        ...
        methods:{
            ...
            async handleForm(event) {
                ...
                //     },
                // });
                // console.log('data',personResult);
                // return false
                // if (accountResult.token && personResult.token) {
                //     console.log('accountResult.token.id',accountResult.token.id);
                //     console.log('personResult.token.id',personResult.token.id);
